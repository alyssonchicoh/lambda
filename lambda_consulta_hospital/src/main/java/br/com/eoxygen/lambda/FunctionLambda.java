...
public class FunctionLambda  implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try{
            ...
            List<HospitalDTO> hospitalDTOList = service.consultar(cnpjCliente,id);

            return ApiGatwayResponseUtil.construirRetorno(gson,hospitalDTOList, HTTPStatus.SUCESSO);
        }catch (Exception e){
            e.printStackTrace();
